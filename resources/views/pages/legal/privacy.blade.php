...
@section('content')
    <x-slot:title>Privacy Policy | Websamsya</x-slot>
        ...
        <div class="bg-white p-8 md:p-12 rounded-[2.5rem] shadow-[0_20px_50px_rgba(20,85,137,0.05)] border border-gray-100">
            ...
            <div class="prose prose-slate max-w-none text-gray-600 space-y-10 leading-relaxed">
                ...
                <section>
                    ...
                    <p>Websamsya, a digital service division of <strong>One Advertisers</strong> ("we," "us," or "our"), is
                        ...
                        <strong>Information Technology Act, 2000</strong> and the <strong>Digital Personal Data Protection
                            (DPDP) Act, 2023</strong> of India.</p>
                </section>
                ...
                <section>
                    <h2 class="text-2xl font-black text-[#145589] mb-4">6. Contact & Grievance</h2>
                    ...
                    <div class="mt-6 p-6 border-l-4 border-[#fd7319] bg-gray-50 rounded-r-2xl">
                        <p class="font-bold text-gray-800">One Advertisers / Websamsya</p>
                        <p>Email: legal@websamsya.com</p>
