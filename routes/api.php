...
Route::prefix('v1')->group(function () {
    ...
    Route::get('/religions/{religion}/castes', [ReligionDataController::class, 'castesForReligion']);

    // ADMIN ONLY ROUTES
    Route::post('/religions', [ReligionDataController::class, 'storeReligion']);
    Route::post('/religions/{religion}/castes', [ReligionDataController::class, 'storeCaste']);
...
Route::prefix('v2')->group(function () {
    ...
    Route::get('ads/{category}/profiles/{gender?}', [AdController::class, 'getAdsByCategory']);
...
Route::middleware(['auth:sanctum', 'role:admin'])->prefix('admin')->group(function () {
    ...
    // To get all profiles
    Route::post('/user/ads/profiles', [AdController::class, 'getAdsProfiles']);
    Route::put('/user/ad/{ad}/status', [AdController::class, 'updateAdProfileStatus']);
